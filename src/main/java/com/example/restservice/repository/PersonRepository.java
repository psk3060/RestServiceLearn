 ...
 * - 런타임 시 @RepositoryRestResource.path에 작성된 경로로 RESTful 엔드포인트 생성(컨트롤러 불필요)
...
public interface PersonRepository extends CrudRepository<Person, Long>{
	...
	List<Person> findByFirstNameOrderByIdAsc(@Param("name") String name) throws Exception;
	
	List<Person> findByLastNameOrderByIdAsc(@Param("name") String name) throws Exception;
